...
public class AnnouncementController {
     ...
     * @return 返回响应体
     * @description : 前端传回文件以及其他参数，添加公告到数据库、并且决定是否发送邮件的操作
     * @author Levi
     ...
     * @return 返回所需页数的公告
     * @description : 通过前端的page返回对应页面的公告
     * @author Levi
    ...
    public ResponseResult deleteAnnouncement(@RequestBody Announcement announcement) {
     ...
     * @description : 根据前端给出的title和time查询指定的Announcement信息
     * @author Levi
     ...
     * @param getmap: 获取关键词
     * @return 返回搜索到的公告的数量
     * @description : 查询公告数量：根据关键词搜索并返回搜索到的公告的数量
     * @author Levi
